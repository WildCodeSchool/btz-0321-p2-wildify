  ...
  return (
    <div className="wd-full h-full p-6">
      ...
      <div className="rounded-3xl flex 900:mt-5 mt-3 items-center  p-2 bg-black bg-opacity-20 shadow-searchbar cursor-pointer hover:bg-opacity-50">
        <img src={WorkingPlaylist} alt="Playlist1" className="w-plist  h-pl border-2 border-green-300 rounded-fullist  rounded-3xl" />
      ...
      <div className=" rounded-3xl flex 900:mt-5 mt-3 items-center p-2 bg-black bg-opacity-20 shadow-searchbar cursor-pointer hover:bg-opacity-50">
        <img src={SportPlaylist} alt="Playlist3" className="w-plist  h-plist  border-2 border-green-300 rounded-full" />
        <div className="flex-col ml-3">
      ...
      <div className=" rounded-3xl flex 900:mt-5 mt-3 items-center p-2 bg-black bg-opacity-20 shadow-searchbar cursor-pointer hover:bg-opacity-50">
        <img src={ChillPlaylist} alt="Playlist3" className="w-plist  h-plis border-2 border-green-300 rounded-full " />
        <div className="flex-col ml-3">
      ...
      <div className=" rounded-3xl flex 900:mt-5 mt-3 items-center  p-2 bg-black bg-opacity-20 shadow-searchbar cursor-pointer hover:bg-opacity-50">
        <img src={PartyPlaylist} alt="Playlist1" className="w-plist  h-plist border-2 border-green-300 rounded-full " />
        <div className="flex-col ml-3">
      ...
      <div className=" rounded-3xl flex 900:mt-5 mt-3 items-center p-2 bg-black bg-opacity-20 shadow-searchbar cursor-pointer hover:bg-opacity-50">
        <img src={OldSchoolPlaylist} alt="Playlist3" className="w-plist  h-plist border-2 border-green-300 rounded-full " />
        <div className="flex-col ml-3">
      ...
      <div className=" rounded-3xl flex 900:mt-5 mt-3 items-center p-2 bg-black bg-opacity-20 shadow-searchbar cursor-pointer hover:bg-opacity-50">
        <img src={GamingPlaylist} alt="Playlist3" className="w-plist  h-plist border-2 border-green-300 rounded-full " />
        <div className="flex-col ml-3">
