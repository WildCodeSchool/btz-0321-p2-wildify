...
function ListPlaylistOnClick({ playlistChoice, isLoading, Return, setCurrentTrack, playLists, myPlaylist }) {
  return (
    <div className="p-6 900:p-10 ">
      ...
      {!isLoading &&
        ...
        myPlaylist.songs.map((song, index) => {
          return (
            <button key={index} type="button" className="bg p-1 w-full focus:outline-none">
