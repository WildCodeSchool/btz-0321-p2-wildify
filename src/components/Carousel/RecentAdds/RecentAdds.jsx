...
function RecentAdds({ item, setCurrentTrack, setMyPlaylist }) {
  ...
  return (
    <div
      ...
      <Card item={item} setMyPlaylist={setMyPlaylist} itemReversed={itemReversed} setCurrentTrack={setCurrentTrack} />
