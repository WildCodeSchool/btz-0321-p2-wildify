...
function RecentAdds({ item, setCurrentTrack, setMyPlaylist, setIsPlaylist }) {
  ...
  return (
    <div
      ...
      <Card item={item} setMyPlaylist={setMyPlaylist} setIsPlaylist={setIsPlaylist} itemReversed={itemReversed} setCurrentTrack={setCurrentTrack} />
