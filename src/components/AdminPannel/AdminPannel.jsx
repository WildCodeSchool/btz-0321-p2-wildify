...
export default function AdminPannel({ item, token, albums }) {
  ...
  return (
    <div className="w-full  absolute  flex flex-row align-middle justify-center items-center  bg-black z-50">
      <div className=" w-full h-full  grid-cols-3 grid-rows-adminDesk grid text-white font-scada">
