...
export default function UploadSongs({ playList }) {
  return (
    <div className="w-full h-full flex-col  flex items-center align-middle justify-center">
      ...
      <input className="my-2 w-4/5  bg-black bg-opacity-50 rounded-xl" type="file" />
      <input className="my-2 w-4/5 px-4 h-14 bg-black bg-opacity-50 rounded-xl" type="text" placeholder="Picture URL" />
