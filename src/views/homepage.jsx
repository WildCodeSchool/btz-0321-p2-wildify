  ...
  return (
    <div
      ...
      <div className="w-full 900:w-5/12 900:ml-24 ">
        ...
        <button
          className="flex items-center justify-center  bg-bginput shadow-input2 focus:outline-none w-8/12 900:w-4/12 mt-5 rounded-lg text-sm text-white py-2 px-2 font-scada hover:text-mainColor"
          onClick={() => {
